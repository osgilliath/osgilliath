...
<img align='right' src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExZnhhMTJsOTJyM2IxMjNsY3YybXVvZW83bWk5MnVsem9ndXBnNG43OCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/5eLDrEaRGHegx2FeF2/giphy.gif" width="350">

```javascript
const maddy = {
  pronouns: "bat" | "man",
  code: [Python, C++, C#, HTML, CSS, Javascript, Java],
  interests: [AI, ML, Game Dev, Cybersecurity, Linux, anything cool],
